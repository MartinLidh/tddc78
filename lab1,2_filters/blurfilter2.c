...
void blurfilter(const int xsize, const int ysize, pixel* src, const int radius, const double *w, const int over,
		 const int under){
  int x,y,x2,y2, wi;
  double r,g,b,n, wc;
...
void blurfilterY(const int xsize, const int ysize, pixel* src, const int radius, const double *w, const int over,
		 const int under){
  int x,y,x2,y2, wi;
  double r,g,b,n, wc;
  pixel dst[MAX_PIXELS];
